...
export const sendBookingRequestEmail = async (booking, recipient) => {
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="background-color: #f5f5f5; padding: 15px; border-radius: 5px; margin: 20px 0;">
        ...
        <p>Duration: ${Math.round((new Date(booking.endTime) - new Date(booking.startTime)) / (1000 * 60 * 60) * 100) / 100} hours</p>
...
export const sendPaymentConfirmationEmail = async (payment, recipient) => {
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
...
// Meeting link email
export const sendMeetingLinkEmail = async (booking, meetingLink, recipient) => {
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
